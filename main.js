...
function navigate(direction) {
    ...
    if (pathname === '/' || pathname.indexOf('/index.php') >= 0) {
        ...
        // Keine weitere Validerung der Antworten: Formular abschicken
        return true;
    }
        ...
        /*
            report.php hat keine Formulardaten, also gibt es auch keine Validierung.
...
function getElementValue(fieldId, defaultValue) {
    ...
    if (inputElement) {
        // Verwende parseInt(), um den String-Wert in eine Integer zu verwandeln.
        return inputElement.value; 
    }
    else {
        // In der aktuellen Seite fehlt das Feld: Default-Wert zurückgeben.
        return defaultValue;
    }
}
